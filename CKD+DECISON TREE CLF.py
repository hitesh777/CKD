# -*- coding: utf-8 -*-
"""
Created on Sat Apr 13 17:49:44 2019
...
accu_dt=(metrics.accuracy_score(y_test,y_predict_dt))*100
confusion_mat_dt=metrics.confusion_matrix(y_test,y_predict_dt)#confusion matrix
...
joblib.dump(clf_dt, 'CKD_DECISIOIN_TREE.pkl')# model save at 98.333% accuracy
"""
